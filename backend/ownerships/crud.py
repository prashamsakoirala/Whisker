...
def get_all_ownerships_by_partnership_id(db: Session, partnership_id: uuid.UUID):
	return db.query(Ownerships).filter(Ownerships.partnership_id == partnership_id).all()
